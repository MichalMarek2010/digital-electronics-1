...
| `WEST_GO`    | red    | green | 4 sec | `10` => `WEST_GO`or `00` => `WEST_WAIT` |
| `WEST_WAIT`  | red    | orange | 2 sec | =>`STOP2` |
| `STOP2`      | red    | red | 1 sec | =>`SOUTH_GO` |
| `SOUTH_GO`   | green  | red | 4 sec | `01` =>`SOUTH_GO` or `00` =>`SOUTH_WAIT` |
| `SOUTH_WAIT` | orange | red | 2 sec | =>`STOP1` |
### State diagram
